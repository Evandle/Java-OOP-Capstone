...
public class AddEmployee1 extends JFrame {
    private JPanel addEmployeePanel;
    private JPanel addEmployee1Pane;
    ...
    private void loadUserDataIntoTable() {
        ...
        ArrayList<Employee> userList = DbHandler.getEmployee();
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new AddEmployee1());
    }
    private void goBack() {
    ...
    public void addEmployee(){
        ...
        try {
            ...
            boolean success = DbHandler.registerUser(username, password, "EMPLOYEE", address);
            if(success) {
                // Show success message and return to main menu
                JOptionPane.showMessageDialog(this, "Sign up successful! Employee can now log in.", "Success", JOptionPane.INFORMATION_MESSAGE);
                new AddEmployee1();
                dispose();
            } else {
